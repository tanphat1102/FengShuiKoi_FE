  ...
  const [cartItems, setCartItems] = useState([
    {
      ...
      title: "Mũi Hàn 500",
      price: 25000,
      image: "https://bizweb.dktcdn.net/thumb/large/100/228/168/products/sualai.jpg?v=1573720306000",
      quantity: 1,
    },
    {
      id: 2,
      ...
      price: 1599000,
      image: "https://bizweb.dktcdn.net/thumb/large/100/228/168/products/sp1-a45a32a1-38d4-4a8a-9c37-e936013858b2.jpg?v=1575877003000",
      quantity: 2,
    },
  ]);
      ...
      <div className="modal-body">
        ...
        <div className="cart-items">
          ...
          <div className="cart-total">
            ...
            <span className="cart-total-price">{total.toLocaleString()} VNĐ</span>
          </div>
        </div>
      </div>
    </div>
